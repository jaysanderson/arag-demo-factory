...
// Match-strength colours are semantic (green/amber/red), deliberately independent
// of the demo's brand palette — a weak match should read as weak in any theme.
export const matchColor = (s: number) => (s >= 0.7 ? '#10B981' : s >= 0.4 ? '#F0A81E' : '#EF6A4D');
  ...
  return (
    <div className="relative inline-flex items-center justify-center" style={{ width: size, height: size }}>
      <svg width={size} height={size} className="-rotate-90">
        ...
        <circle
          cx={size / 2} cy={size / 2} r={r} fill="none" stroke={stroke} strokeWidth={9} strokeLinecap="round"
